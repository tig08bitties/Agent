...
"[project]/node_modules/.pnpm/@solana+web3.js@1.98.4_bufferutil@4.0.9_typescript@5.8.3_utf-8-validate@5.0.10/node_modules/@solana/web3.js/lib/index.browser.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ class Connection {
    ...
    async confirmTransactionUsingDurableNonceStrategy(param) {
        ...
        try {
            ...
            if (outcome.__type === TransactionStatus.PROCESSED) {
                ...
                if (signatureStatus === null || signatureStatus === void 0 ? void 0 : signatureStatus.value) {
   ...
   */ async getRecentPrioritizationFees(config) {
        var _config_lockedWritableAccounts;
        const accounts = config === null || config === void 0 ? void 0 : (_config_lockedWritableAccounts = config.lockedWritableAccounts) === null || _config_lockedWritableAccounts === void 0 ? void 0 : _config_lockedWritableAccounts.map((key)=>key.toBase58());
        const args = (accounts === null || accounts === void 0 ? void 0 : accounts.length) ? [
            accounts
        ] : [];
...
async function sendAndConfirmRawTransaction(connection, rawTransaction, confirmationStrategyOrConfirmOptions, maybeConfirmOptions) {
    ...
    if (status.err) {
        if (signature != null) {
            throw new SendTransactionError({
                action: (sendOptions === null || sendOptions === void 0 ? void 0 : sendOptions.skipPreflight) ? 'send' : 'simulate',
                signature: signature,
                transactionMessage: "Status: (".concat(JSON.stringify(status), ")")
            });
        }
...
//# sourceMappingURL=e32ee_%40solana_web3_js_lib_index_browser_esm_be8946c0.js.map